...
\newglossaryentry{ABIg}{
    ...
    In the context of Ethereum and other blockchain networks, the ABI is specified as a JSON array of function descriptions and enables developers to better understand how to interact with their respective smart contracts~\autocite[134]{antonopoulos_mastering_2019}},
}
