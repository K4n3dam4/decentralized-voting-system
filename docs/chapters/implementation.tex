...
To begin writing the smart contract, we will later deploy when \glsplural{Admin} create an election; we switch to Remix \gls{IDE} and open the \emph{Election.sol} file we created earlier.
